...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d1 = new Department(1, "Quality Assurance");
            Department d2 = new Department(2, "Public Relations");
            Department d3 = new Department(3, "Research and Development");
            Department d4 = new Department(4, "Payroll");
            Department d5 = new Department(5, "Tech Support");
            Department d6 = new Department(6, "Media Relations");
            Department d7 = new Department(7, "Computers");
            Department d8 = new Department(8, "Eletronics");
            Department d9 = new Department(9, "Fashion");
            Department d10 = new Department(10, "Books");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d7);
            ...
            _context.Departments.AddRange(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10);
